...
- code-review-graph evidence: latest `code-review-graph build --skip-flows && code-review-graph detect-changes` ran; graph built 137 files / 1597 nodes / 24493 edges; risk score 0.50. Function-level gaps for transfer service/frontend helpers are covered by backend unit tests plus focused and full real Chrome assertions.
